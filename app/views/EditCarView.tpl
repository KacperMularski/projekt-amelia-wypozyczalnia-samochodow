								...
								<article>
                                   ...
                                   {if $msgs->getMessages()}
                                    ...
                                    <section class="col-6 col-12-narrower">
										...
										<form action="{url action='saveEditCar' id=$form->id}" method="post">
											<div class="row gtr-50">
                                                ...
                                                <div class="col-6 col-12-mobilep">
													{if isset($form->wypozyczony)}
														<input id="id_wypozyczony" type="text"  name="wypozyczony"  placeholder="Czy wypożyczony" value="{$form->wypozyczony}" />
													{/if}
													{if !isset($form->wypozyczony)}
                                                ...
                                                <div class="col-6 col-12-mobilep">
													{if isset($form->aktywny)}
														<input id="id_aktywny" type="text"  name="aktywny"  placeholder="Aktywny" value="{$form->aktywny}" />
													{/if}
													{if !isset($form->aktywny)}
